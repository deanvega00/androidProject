...
public class DeleteFavTask extends AsyncTask<String, Void, String> {
    String data = "", Content;
    String catId;
    String stdId;
    ...
    public DeleteFavTask(String catId, String stdId) {
        this.catId = catId;
        this.stdId = stdId;
    ...
    protected String doInBackground(String... strings) {
        ...
        // Send data
        try {
            String urll = ConstantString.URL + "delete_fav.php?";
